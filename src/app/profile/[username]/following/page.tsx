            ...
            <div className="max-w-4xl mx-auto px-4 py-8">
                ...
                <div className="mb-8">
                    ...
                    <p className="text-slate-600 dark:text-slate-400">
                        {profile.following_count} {profile.following_count === 1 ? 'pessoa' : 'pessoas'}
                    </p>
                </div>
                                        ...
                                        >
                                            ...
                                            <div className="flex-1 min-w-0">
                                                ...
                                                <div className="flex gap-3 text-xs text-slate-500 mt-1">
                                                    <span>{followedUser.followers_count || 0} seguidores</span>
                                                    <span>{followedUser.following_count || 0} seguindo</span>
                                                </div>
                                            </div>
                                        </Link>
